...
export const AlbumCard = ({simplifiedAlbum, fromList}: AlbumCardProps) => {
    ...
    return (<Card sx={{width: '350px', height: '200px', display: 'inline-flex'}}>
        <Box sx={{display: 'flex', flexDirection: 'column'}}>
            ...
            {simplifiedAlbum && <AlbumCardIcons album={simplifiedAlbum} fromList={fromList} toggleListDialog={toggleListDialog}/>}
        </Box>
        <CardMedia
            component="img"
